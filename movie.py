...
sql="insert into customer_data(location,language,theater,movie_name,screen_no,booking_timing,ticket_status,booked_tickets,ticket_cost)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
val=(loc,lan,the,mov,scr,x,cla,tic,cost)
